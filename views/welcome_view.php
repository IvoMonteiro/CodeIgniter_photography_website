...
<style>
html { 
  background: url(<?php echo base_url();?>uploads/start/andi-frank-bg-2048.jpg) no-repeat center center fixed; 
...
html { 
  background: url(<?php echo base_url();?>uploads/start/andi-frank-bg-1024.jpg) no-repeat center center fixed; 
  -webkit-background-size: cover;
  -moz-background-size: cover;
  -o-background-size: cover;
  background-size: cover;
...
html { 
  background: url(<?php echo base_url();?>uploads/start/andi-frank-bg-768.jpg) no-repeat center center fixed; 
  -webkit-background-size: cover;
  -moz-background-size: cover;
  -o-background-size: cover;
  background-size: cover;
...
.logo{
	  ...
	  position: relative;
	  background: url(<?php echo base_url();?>uploads/start/andi-frank-logo.png);
